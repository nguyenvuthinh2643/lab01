...
public async Task<IPagedList<Post>> GetPagedPostAsync(
    ...
    CancellationToken cancellationToken = default)
		...
		private object FilterPosts(PostQuery condition)
		{
			throw new NotImplementedException();
		}

		public Task<IPagedList<Post>> GetPagedPostsAsync(PostQuery postQuery, int pageNumber = 1, int pageSize = 10, CancellationToken cancellationToken = default)
		{
			throw new NotImplementedException();
		}
	}
